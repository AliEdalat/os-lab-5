...
EXTRA=\
	mkfs.c ulib.c user.h cat.c sort.c tickettest.c rwtest.c wrtest.c ps.c chpr.c chmfq.c chticket.c schtest.c sharedmtest.c shutdown.c echo.c forktest.c grep.c kill.c\
